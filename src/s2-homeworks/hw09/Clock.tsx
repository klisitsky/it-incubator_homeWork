...
function Clock() {
    ...
    let stringDayFormatter = new Intl.DateTimeFormat("en", {
        weekday: "long"
    });
    ...
    let stringMonthFormatter = new Intl.DateTimeFormat("en", {
        month: "long",
    });

    const start = () => {
        let timerId = setInterval(() => setDate(new Date((Date.now()))), 1000)
        setTimerId(+timerId)
    ...
    const stringDay = stringDayFormatter.format(date) || <br/> // пишут студенты
    ...
    const stringMonth = stringMonthFormatter.format(date) || <br/> // пишут студенты
